...
请使用命令`xmake build work4_1`生成程序，使用`xmake run work4_1`运行程序。
...
完成任务以后，请使用命令`xmake build work4_2`生成程序，使用`xmake run work4_2`运行程序。

### 任务2：

请修改[interface_unit/main2.cpp](interface_unit/main2.cpp)，尝试只导入my_lib.foo模块，不导入my_lib.bar模块。

完成任务以后，请使用命令`xmake build work4_3`生成程序，使用`xmake run work4_3`运行程序。
